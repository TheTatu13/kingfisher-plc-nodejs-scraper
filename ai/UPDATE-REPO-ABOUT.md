...
## Description
Scraper automat pentru locurile de muncă KINGFISHER INFORMATION TECHNOLOGY SERVICES (ROMANIA) S.R.L. (CIF: 51987250) — extrage de pe the company careers site și ANOFM, validează via ANAF și publică pe peviitor.ro
...
gh repo edit <owner>/<repo> --add-topic job-seeker-ro-spider --add-topic peviitor-ro \
  ...
  --description "Scraper pentru KINGFISHER INFORMATION TECHNOLOGY SERVICES (ROMANIA) S.R.L. - peViitor.ro"
