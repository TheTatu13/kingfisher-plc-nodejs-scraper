...
Fill this in per derived company. Check `https://www.kingfisher.com/robots.txt` before the
...
| Path | Role |
|---|---|
| `https://careers.kingfisher.com/job-search` | Public list of open positions (server-rendered HTML) |
| `` | Job sitemap — canonical `https://www.kingfisher.com/jobs/<slug>/` permalinks |
| `https://www.kingfisher.com/jobs/<slug>/` | Individual job pages (only referenced, not fully crawled) |
