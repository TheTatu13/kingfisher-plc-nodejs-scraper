...
```bash
gh issue list --repo TheTatu13/kingfisher-plc-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "KINGFISHER INFORMATION TECHNOLOGY SERVICES (ROMANIA) S.R.L.", not the old template
