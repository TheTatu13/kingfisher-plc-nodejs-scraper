...
This scraper extracts job listings for **KINGFISHER INFORMATION TECHNOLOGY SERVICES (ROMANIA) S.R.L.** (CIF: 51987250) from the company's own careers site and from ANOFM, and imports them to peviitor.ro.

Targets: https://careers.kingfisher.com/job-search, , https://mediere.anofm.ro
...
- **Kingfisher — listing**: `https://careers.kingfisher.com/job-search` — pagina publică de posturi deschise (HTML server-rendered)
- **Kingfisher — sitemap**: `` — permalink-uri canonice `/joburi/<slug>/`
