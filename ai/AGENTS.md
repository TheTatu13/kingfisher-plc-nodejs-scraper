...
```bash
gh run view <RUN_ID> --repo TheTatu13/kingfisher-plc-nodejs-scraper --json status -q .status
```
...
**On every session:**
1. Check open GitHub issues: `gh issue list --repo TheTatu13/kingfisher-plc-nodejs-scraper --state open`
